...
%>
                                <tr>
                                    ...
                                    <td style="width: 10%">
                                      <div>
                                          <a href="action.jsp?id=<%=resultSet.getString("id")%>"> <button type="button" class="btn btn-default btn-xs btn-filter"><span class="glyphicon glyphicon-ok"></span>Action</button></a>
                                        </div>
                                    </td>
                                </tr>
<%
