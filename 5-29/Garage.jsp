            ...
            <div class="row content">
                <div class="panel panel-primary filterable">
                        <div class="panel-heading">
                            <h3 class="panel-title">My Garage<span style="color: white; font-weight: bold;"></span></h3>
                        </div>
                        <div class="table-responsive">
                        <table class="table table-bordered table-hover">
                            <tr class="filters">
                              <th style="width: 5%">
                                <input type="text" class="form-control" placeholder="CarID" disabled>
                              </th>
                              <th style="width: 15%">
                              ...
                              <th style="width: 15%">
                                <input type="text" class="form-control" placeholder="Price /Day" disabled>
                              </th>
                              <th style="width: 15%">
                                <input type="text" class="form-control" placeholder="Penalty /Day" disabled>
                              </th>
                              <th style="width: 10%">
...
<%
    //NEED TO FINISH SOMETHING ELSE HERE
try{
  connection = DriverManager.getConnection(connectionUrl+database, userid, password);
  statement=connection.createStatement();
...
%>
                                <tr>
                                    ...
                                    <td style="width: 15%"><%=resultSet.getString("Brand") %></td>
                                    <td style="width: 15%"><%=resultSet.getString("Model") %></td>
                                    <td style="width: 15%"><%=resultSet.getString("Rate") %></td>
                                    <td style="width: 15%"><%=resultSet.getString("Penalty") %></td>
                                    <td style="width: 10%"><%=resultSet.getString("Status") %></td>
                                    <td style="width: 10%">
                                      <div>
                                          <a href="garageUpdate.jsp?CarID=<%=resultSet.getString("CarID")%>"> <button type="button" class="btn btn-default btn-xs btn-filter"><span class="glyphicon glyphicon-console"></span>Action</button></a>
                                        </div>
                                    </td>
                                </tr>
<%
