    ...
    else
    {
      if(isset($_POST['terms']))
      {
          ...
          if ($_POST['password'] == $_POST['confirm_password'])
          {
              ...
              $sql = "INSERT INTO customer ( FirstName, LastName, Gender, Email, PhoneNumber, Password, Age, Role) VALUES ( '$firstname', '$lastname', '$gender', '$email', '$phonenumber', '$hashed_password', $age, 'Customer');";
