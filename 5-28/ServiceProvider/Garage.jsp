                ...
                <div class="panel panel-primary filterable">
                        ...
                        <table class="table table-bordered table-hover">
                            <tr class="filters">
                              ...
                              <th style="width: 15%">
                                <input type="text" class="form-control" placeholder="Penalty" disabled>
                              </th>
                              <th style="width: 10%">
...
%>
                                <tr>
                                    ...
                                    <td style="width: 10%">
                                      <div>
                                          <a href="garageUpdate.jsp?id=<%=resultSet.getString("CarID")%>"> <button type="button" class="btn btn-default btn-xs btn-filter"><span class="glyphicon glyphicon-console"></span>Action</button></a>
                                        </div>
                                    </td>
                                </tr>
<%
